...
msr <- read.csv("/Users/Meeko/Sync/Google\ Drive/Niyogi\ Lab/Zofingiensis/Switch\ Paper/Switch\ Paper\ Part\ B/Replot/pigments_hxk1-2.csv", header=TRUE,as.is=TRUE)
...
ggsave(filename = "Hxk1-2_pigments.pdf", width=5.696, height = 2.765, units="cm", plot=last_plot(),scale = 5 ,path="/Users/Meeko/Sync/Google Drive/Niyogi Lab/Zofingiensis/Switch Paper/Switch Paper Part B/Replot/Plots/To edit/")
#Inconsistancies in the new and old plots. Writing data to file for Melissa to look at. 
#write.csv(msr2,file="~/Desktop/hxk1-2_pigment_data_for_MSR_to_check.csv")