...
msr <- read.csv("/home/daniel/Sync/Google Drive/Niyogi Lab/Zofingiensis/Switch Paper/Switch Paper Part B/Replot/pigments_WT.csv", header=TRUE,as.is=TRUE)
...
#Plot needs to be manually jittered in illustrator and labels addedmanually. 
...
p2+ 
  ...
  scale_y_continuous(breaks = seq(0,500,50),limits = c(0,520),expand=c(0,0)) +
...
ggsave(filename = "wt_pigments.pdf", width=5.696, height = 2.765, units="cm", plot=last_plot(),scale = 5 ,path="/Users/Meeko/Sync/Google Drive/Niyogi Lab/Zofingiensis/Switch Paper/Switch Paper Part B/Replot/Plots/To edit/")
